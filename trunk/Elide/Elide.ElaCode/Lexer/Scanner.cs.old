...
internal sealed class Scanner {
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "__internal": t.kind = 37; break;
			...
			case "deriving": t.kind = 43; break;
			case "opentype": t.kind = 44; break;
			default: break;
		}
	}
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 46:
				...
				else if (ch == '.') {apx++; AddCh(); goto case 54;}
				else if (ch == 'E' || ch == 'e') {AddCh(); goto case 17;}
				else if (ch == 'D' || ch == 'F' || ch == 'd' || ch == 'f') {AddCh(); goto case 20;}
				else {t.kind = 3; break;}
			case 47:
				if (ch >= 'A' && ch <= 'Z' || ch == '_' || ch >= 'a' && ch <= 'z') {AddCh(); goto case 55;}
