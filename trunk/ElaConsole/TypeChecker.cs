...
namespace ElaConsole
{
	public sealed class TypeChecker
	{
		...
		private void PrintOutScope(string pad, Scope scope)
		{
		...
		private ElaTraits GetBinaryType(ElaBinary bin, Scope scope)
		{
			switch (bin.Operator)
			{
		...
		private TypeTag GetExpressionType(ElaExpression exp, Scope scope)
		{
			switch (exp.Type)
			{
		...
		private TypeTag GetMatchType(ElaMatch mt, Scope scope)
		{
			var type = TypeTag.Any();
			var lc = default(Scope);
		...
		private TypeTag GetFunctionType(ElaFunctionLiteral fun, Scope scope)
		{
		...
		private TypeTag GetPatternType(ElaPattern pat, Scope scope)
		{
			if (pat == null)
