...
namespace Ela.Runtime.ObjectModel
{
	...
	internal sealed class DelegateFunction<T1,T2,T3,T4,T5,T6> : DelegateFunction
	{
		...
		internal DelegateFunction(string name, ElaFun<T1,T2,T3,T4,T5,T6> func) : base(4, name)
		{
			this.func = func;
		}
    ...
    internal sealed class DelegateFunction<T1,T2,T3,T4,T5,T6,T7> : DelegateFunction
	{
		...
		internal DelegateFunction(string name, ElaFun<T1,T2,T3,T4,T5,T6,T7> func) : base(4, name)
		{
			this.func = func;
		}
    ...
    internal sealed class DelegateFunction<T1,T2,T3,T4,T5,T6,T7,T8> : DelegateFunction
	{
		...
		internal DelegateFunction(string name, ElaFun<T1,T2,T3,T4,T5,T6,T7,T8> func) : base(4, name)
		{
			this.func = func;
		}
    ...
    internal sealed class DelegateFunction<T1,T2,T3,T4,T5,T6,T7,T8,T9> : DelegateFunction
	{
		...
		internal DelegateFunction(string name, ElaFun<T1,T2,T3,T4,T5,T6,T7,T8,T9> func) : base(4, name)
		{
			this.func = func;
		}
