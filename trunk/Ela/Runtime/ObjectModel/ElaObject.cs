...
namespace Ela.Runtime.ObjectModel
{
	public abstract class ElaObject
	{
		...
		{
			return ((ElaTypeCode)TypeId).GetShortForm();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitEq, ThisToString(left, right, ctx), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitOrd, ThisToString(left, right, ctx), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitLen, ToString(), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitEnum, ToString(), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitGet, ToString(), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitSet, ToString(), ((ElaTypeCode)TypeId).GetShortForm());			
		}


		protected internal virtual ElaValue GetMax(ExecutionContext ctx)
		{
			ctx.Fail(ElaRuntimeError.TraitBound, ToString(), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitConcat, ThisToString(left, right, ctx), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitNum, ThisToString(left, right, ctx), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitBit, ThisToString(left, right, ctx), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitBit, ToString(), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitNeg, ToString(), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitBool, ToString(), ((ElaTypeCode)TypeId).GetShortForm());
			return false;
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitFold, ToString(), ((ElaTypeCode)TypeId).GetShortForm()); 
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitFieldGet, ToString(), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitFieldSet, ToString(), ((ElaTypeCode)TypeId).GetShortForm());			
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitShow, String.Empty, ((ElaTypeCode)TypeId).GetShortForm());
			return String.Empty;
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitConvert, ToString(), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitCall, ToString(), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitThunk, ToString(), ((ElaTypeCode)TypeId).GetShortForm());
			return Default();
		}
		...
		{
			ctx.Fail(ElaRuntimeError.TraitTag, ToString(), ((ElaTypeCode)TypeId).GetShortForm());
			return String.Empty;
		}
