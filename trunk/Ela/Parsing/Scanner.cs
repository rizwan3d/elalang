...
internal sealed class Scanner {
	...
	void CheckLiteral() {
		switch (t.val) {
			...
			case "base": t.kind = 27; break;
			case "match": t.kind = 28; break;
			case "is": t.kind = 30; break;
			case "let": t.kind = 31; break;
	...
	Token NextToken() {
		...
		switch (state) {
			...
			case 47:
				...
				else {t.kind = 15; t.val = new String(tval, 0, tlen); CheckLiteral(); return t;}
			case 48:
				{t.kind = 16; break;}
			case 49:
				{t.kind = 17; break;}
			...
			case 77:
				{t.kind = 54; break;}
			case 78:
				if (ch == 'i') {AddCh(); goto case 79;}
				else {goto case 0;}
			case 79:
				if (ch == 'n') {AddCh(); goto case 80;}
				else {goto case 0;}
			case 80:
				if (ch == 't') {AddCh(); goto case 81;}
				else {goto case 0;}
			case 81:
				if (ch == 'e') {AddCh(); goto case 82;}
				else {goto case 0;}
			case 82:
				if (ch == 'r') {AddCh(); goto case 83;}
				else {goto case 0;}
			case 83:
