...
namespace Ela.Runtime.ObjectModel
{
    ...
    {
        protected DelegateFunction(int args, string name)
            : base(args)
        {
            Name = name;
        }
    ...
    internal sealed class DynamicDelegateFunction : DelegateFunction
    {
        ...
        internal DynamicDelegateFunction(string name, Delegate func)
            : base(1, name)
        {
            this.func = func;
        }
    ...
    internal sealed class DelegateFunction<T1> : DelegateFunction
    {
        ...
        internal DelegateFunction(string name, ElaFun<T1> func)
            : base(1, name)
        {
            this.func = func;
        }
    ...
    internal sealed class DelegateFunction<T1, T2> : DelegateFunction
    {
        ...
        internal DelegateFunction(string name, ElaFun<T1, T2> func)
            : base(1, name)
        {
            this.func = func;
        }
    ...
    internal sealed class DelegateFunction<T1, T2, T3> : DelegateFunction
    {
        ...
        internal DelegateFunction(string name, ElaFun<T1, T2, T3> func)
            : base(2, name)
        {
            this.func = func;
        }
    ...
    internal sealed class DelegateFunction<T1, T2, T3, T4> : DelegateFunction
    {
        ...
        internal DelegateFunction(string name, ElaFun<T1, T2, T3, T4> func)
            : base(3, name)
        {
            this.func = func;
        }
    ...
    internal sealed class DelegateFunction<T1, T2, T3, T4, T5> : DelegateFunction
    {
        ...
        internal DelegateFunction(string name, ElaFun<T1, T2, T3, T4, T5> func)
            : base(4, name)
        {
            this.func = func;
        }
    ...
    internal sealed class DelegateFunction<T1, T2, T3, T4, T5, T6> : DelegateFunction
    {
        ...
        internal DelegateFunction(string name, ElaFun<T1, T2, T3, T4, T5, T6> func)
            : base(5, name)
        {
            this.func = func;
        }
    ...
    internal sealed class DelegateFunction<T1, T2, T3, T4, T5, T6, T7> : DelegateFunction
    {
        ...
        internal DelegateFunction(string name, ElaFun<T1, T2, T3, T4, T5, T6, T7> func)
            : base(6, name)
        {
            this.func = func;
        }
    ...
    internal sealed class DelegateFunction<T1, T2, T3, T4, T5, T6, T7, T8> : DelegateFunction
    {
        ...
        internal DelegateFunction(string name, ElaFun<T1, T2, T3, T4, T5, T6, T7, T8> func)
            : base(7, name)
        {
            this.func = func;
        }
    ...
    internal sealed class DelegateFunction<T1, T2, T3, T4, T5, T6, T7, T8, T9> : DelegateFunction
    {
        ...
        internal DelegateFunction(string name, ElaFun<T1, T2, T3, T4, T5, T6, T7, T8, T9> func)
            : base(8, name)
        {
            this.func = func;
        }
